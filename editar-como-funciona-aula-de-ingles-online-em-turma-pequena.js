(function () {
  ...
  const PAGE_KEY = "como-funciona-aula-de-ingles-online-em-turma-pequena";
  ...
  const FIELD_GROUPS = Object.freeze([
    ...
    {
      title: "Começo da aula",
      fields: [
        ["beginning_title", "Título da seção", "short"],
        ["beginning_p1", "Primeiro parágrafo", "long"],
        ["beginning_p2", "Segundo parágrafo", "long"]
      ]
    },
    {
      title: "Gramática",
      fields: [
        ["grammar_title", "Título da seção", "short"],
        ["grammar_p1", "Primeiro parágrafo", "long"],
        ["grammar_p2", "Segundo parágrafo", "long"]
      ]
    },
    {
      title: "Conversação",
    ...
    },
    {
      ...
      fields: [
        ["errors_title", "Título da seção", "short"],
        ["errors_p1", "Primeiro parágrafo", "long"],
        ["errors_p2", "Segundo parágrafo", "long"]
      ]
    },
    {
      title: "Dinâmica do grupo reduzido",
      fields: [
        ["small_group_title", "Título da seção", "short"],
        ["small_group_p1", "Primeiro parágrafo", "long"],
        ["small_group_p2", "Segundo parágrafo", "long"]
      ]
    },
    {
      title: "Depois da aula",
      fields: [
        ["after_class_title", "Título da seção", "short"],
        ["after_class_p1", "Primeiro parágrafo", "long"],
        ["after_class_p2", "Segundo parágrafo", "long"]
      ]
    },
    {
      title: "Participação",
      fields: [
        ["participation_title", "Título da seção", "short"],
        ["participation_p1", "Parágrafo", "long"]
      ]
    },
    {
