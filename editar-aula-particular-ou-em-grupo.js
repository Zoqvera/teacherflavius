(function () {
  ...
  const FIELD_GROUPS = Object.freeze([
    ...
    {
      title: "Comparação por critério",
      fields: [
        ["comparison_title", "Título da seção", "short"],
        ["comparison_label_1", "Rótulo 1", "short"],
        ["comparison_text_1", "Texto 1", "short"],
        ["comparison_label_2", "Rótulo 2", "short"],
        ["comparison_text_2", "Texto 2", "short"],
        ["comparison_label_3", "Rótulo 3", "short"],
        ["comparison_text_3", "Texto 3", "short"],
        ["comparison_label_4", "Rótulo 4", "short"],
        ["comparison_text_4", "Texto 4", "short"],
        ["comparison_label_5", "Rótulo 5", "short"],
        ["comparison_text_5", "Texto 5", "short"],
        ["comparison_label_6", "Rótulo 6", "short"],
        ["comparison_text_6", "Texto 6", "short"]
      ]
    },
    {
      title: "Iniciantes",
