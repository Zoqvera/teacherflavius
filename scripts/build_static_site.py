...
AUTH_NAVIGATION_SERVICE_RE = re.compile(
    r'<script\b[^>]*\bsrc=["\']/?auth_navigation_service\.js(?:\?[^"\']*)?["\'][^>]*>\s*</script>',
    re.IGNORECASE,
)
...
AUTH_DEPENDENCIES = (
    ...
    (
        "Auth navigation service",
        AUTH_NAVIGATION_SERVICE_RE,
        "/auth_navigation_service.js?v=20260902-1",
    ),
    (
