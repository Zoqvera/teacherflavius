(function () {
  ...
  const scriptAssets = Object.freeze({
    ...
    analyticsAttribution: freezeAsset({ id: "teacher-flavius-analytics-attribution", src: "/analytics_attribution.js?v=20260922-commercial-guard-1" }),
    ...
    mobileTopNavigation: freezeAsset({ id: "teacher-flavius-mobile-top-navigation", src: "/mobile_top_navigation.js?v=20260922-standard-menu-1" }),
    ...
    marketingWhatsappTracker: freezeAsset({ id: "teacher-flavius-marketing-whatsapp-tracker", src: "/marketing_whatsapp_tracker.js?v=20260922-individual-cta-2" }),
