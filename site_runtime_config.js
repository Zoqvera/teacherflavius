(function () {
  ...
  const scriptAssets = Object.freeze({
    whatsappLeadForm: freezeAsset({ id: "teacher-flavius-whatsapp-lead-form", src: "/whatsapp_lead_form.js?v=20260902-direct-2" }),
    ...
    sitePageRuntime: freezeAsset({ id: "teacher-flavius-site-page-runtime", src: "/site_page_runtime.js?v=20260909-chargebacks-1" }),
    ...
    marketingWhatsappTracker: freezeAsset({ id: "teacher-flavius-marketing-whatsapp-tracker", src: "/marketing_whatsapp_tracker.js?v=20260904-1" }),
    paymentOperationsDashboard: freezeAsset({ id: "teacher-flavius-payment-operations-dashboard", src: "/payment_operations_dashboard.js?v=20260909-2" }),
    ...
    paymentChargebackOperations: freezeAsset({ id: "teacher-flavius-payment-chargeback-operations", src: "/payment_chargeback_operations.js?v=20260909-1" }),
