(function () {
  ...
  const scriptAssets = Object.freeze({
    ...
    mobileTopNavigation: freezeAsset({ id: "teacher-flavius-mobile-top-navigation", src: "/mobile_top_navigation.js?v=20260924-home-exclusion-1" }),
    ...
    marketingWhatsappTracker: freezeAsset({ id: "teacher-flavius-marketing-whatsapp-tracker", src: "/marketing_whatsapp_tracker.js?v=20260924-whatsapp-coverage-1" }),
