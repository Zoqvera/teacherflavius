...
begin
  ...
  -- Exceções comerciais existentes: as turmas 73 e 75 aceitam até 5 alunos.
  -- Todas as demais turmas mantêm a capacidade padrão de 4 alunos.
  capacity_limit := case when new.class_number in (73, 75) then 5 else 4 end;
