-- Corrective disaster-recovery overlay for Google-account linking.
-- Preserve enrollment history when the verified Google account is the same
-- Gmail mailbox written with different dots in the local part.
